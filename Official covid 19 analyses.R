...
ui<- basicPage(selectInput('Countries', 'Continents' ,choices = unique(covid_cases_data$Continent)),sliderInput('values', 'top x values',  min = 5, max = 30, value = 1), plotlyOutput('distplot'))
